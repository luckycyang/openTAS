...
parser.add_argument(
    "--host", type=str, default="www.funasr.com", required=False, help="host ip, localhost, 0.0.0.0"
)
...
async def record_microphone():
    ...
    stream = p.open(
        format=FORMAT, channels=CHANNELS, rate=RATE, input=True, frames_per_buffer=CHUNK, input_device_index=6
    )
    print("Recording...")
    # hotwords
    fst_dict = {}
